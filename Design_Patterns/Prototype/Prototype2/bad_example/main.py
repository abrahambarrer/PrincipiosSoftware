...
class Carpeta:
    def __init__(self, nombre):
        ...
        print(f'Cargando contenido de la carpeta "{self.nombre}" desde el docsp')
        time.sleep(1)
...
if __name__ == '__main__':
    ...
    print(f'\n Creacion finalizada en {end_time - star_time:.2f} segundos\n')
    print('Estructura del proyecto alpha: ')
    proyecto_alpha.mostrar_contenido()

    print('Estructura del proyecto beta: ')
